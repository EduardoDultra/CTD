CREATE SCHEMA  IF NOT EXISTS `Jogos-Xdh`;
USE `Jogos-Xdh`;
...
(6,'The Last of Us', 'O que parecia ser um simples fungo tornou-se um pesadelo. Antes algo que atingia apenas pequenos insetos, o fungo passou a se alastrar aos humanos, se acomodando em seus cérebros e fazendo com que perdessem a razão, ficando extremamente violentos e insanos. Vinte anos depois da primeira infecção, o mundo está totalmente mudado. Pessoas vivem em cidades devastadas e fechadas, tentando garantir sua própria sobrevivência em meio a escassez de comida, água e medicamentos. Quanto mais tempo se passava, mais os fungos se desenvolviam nos infectados, criando verdadeiras aberrações e cada vez mais mortais. Um verdadeiro cenário pós-apocalíptico aguarda Joel e Ellie. Joel é um homem que viveu o começo de todo este pesadelo, agora calejado pela vida de sobrevivência contra os infectados. Ellie é uma garota de 16 anos que nasceu neste mundo já devastado e desconhece muito do que fora antes. Agora ambos devem partir em busca de uma pista da possível cura para a infecção, a grande esperança de toda a humanidade. ', 2013, 9.4, 159.9, '18'),
(7,'PUBG', 'O jogador é inserido em um grande mapa onde o último a sobreviver sai vitorioso. A partida começa com o seu personagem caindo de paraquedas em uma ilha e deve buscar os recursos para vencer a rodada. ', 2016, 7.2, 89.9, '16'),
(8,'Fortnite', 'A Tempestade chegou sem aviso. 98% da população mundial sumiu... Depois vieram os monstros. Lidere os Heróis remanescentes do mundo na luta para conter a Tempestade. Construa fortalezas enormes, crie armas exóticas, encontre tesouros e aprimore seus Heróis. Enfrente a Tempestade junto com quatro aliados on-line. ', 2017, 7.3, 89.9, '12'),
(9,'Age of Empires II', 'The Age of Kings é ambientado na Idade Média e contém 13 civilizações jogáveis. Jogadores focam em coletar recursos, com os quais eles usam para construir vilas, criar tropas, e finalmente destruir seus inimigos. Possui também cinco campanhas históricas, que coloca o jogador a se especializar em condições históricas.', 1999, 8.6, 199.9, 'Livre'),
(10,'Street Fighter 2', 'Street Fighter II é um jogo de luta competitivo, lançado originalmente para as máquinas arcade em 1991. É o segundo jogo da série e a sequela do jogo original, lançado em 1987. É atribuído ao sucesso de Street Fighter II a popularização dos jogos de luta durante a década de 1990, inspirando outros produtores a criarem as suas próprias séries, popularizando o gênero e começando o renascimento da indústria de máquinas arcade, algo que não se via desde os dias de Pac-Man.', 1991, 9.2, 199.9, 'Livre'),
(11,'World of Warcraft', 'World of Warcraft é um jogo online em que jogadores de todo o planeta assumem papéis de heróis fantásticos para explorar um mundo virtual repleto de magia, mistério e aventuras sem limites. ', 2004, 8.2, 249.9, '12'),
(12,'League of Legends', 'League of Legends (LoL) é um jogo do gênero multiplayer online battle arena desenvolvido pela Riot Games para PC. League of Legends foi bem recebido desde o seu lançamento e sua popularidade cresceu ao decorrer dos anos. Em julho de 2012, League of Legends foi o jogo mais jogado para computador na América do Norte e Europa. Até janeiro de 2014, mais de 67 milhões de pessoas jogavam League of Legends por mês, 27 milhões por dia e mais de 7,5 milhões durante o horário de pico. League of Legends tem um cenário competitivo grande e ativo. ', 2009, 6.8, 49.9, 'Livre'),
(13,'Super Mario World', 'Super Mario World é um jogo de plataforma produzido pela Nintendo. Como nos jogos anteriores da série, o roteiro envolve Mario atravessando terras distintas numa jornada para resgatar a Princesa Peach, que foi capturada por Bowser. ', 1990, 9.6, 129.9, 'Livre'),
(14,'Super Mario Bros 3', 'Neste jogo, o Reino dos Cogumelos está passando por um longo período de paz graças aos esforços dos irmãos Mario e Luigi. Entretanto, o reino forma uma entrada para o Mundo dos Cogumelos onde as coisas não vão bem. Bowser enviou seus sete filhos para este mundo para que eles fizessem as travessuras que quisessem. Lá, eles roubaram os cetros mágicos reais de cada país daquele mundo e transformaram os seus reis em animais. Para fazer com que tudo volte ao normal, Mario e Luigi devem recuperar os cetros mágicos e fazer com que os reis voltem ao normal. Para isso, eles contarão com a ajuda da Princesa Peach, que se comunica com eles através de cartas. ', 1988, 9.1, 99.9, 'Livre'),
(15,'The Elder Scrolls V: Skyrim', 'The Elder Scrolls V: Skyrim, quinto game da série de RPG medieval da Bethesda, se passa 200 anos após os eventos de Oblivion. Uma guerra civil se instalou após o assassinato de um dos reis, enquanto o deus Alduin, em forma de dragão, surge para destruir o mundo. O jogador deve derrotá-lo e impedir a destruição de Skyrim. Além de uma nova e poderosa engine, que promete gráficos excelentes, o jogo vem com melhorias na interface e um sistema de combate aperfeiçoado. ', 2011, 9.2, 99.9, '18'),
(16,'The Witcher 3', 'The Witcher 3: Wild Hunt é o terceiro capítulo da saga de Geralt of Rivia, baseado no livro do famoso escritor polonês Andrzej Sapkowski. The Witcher 3 se passa logo após os fatos do segundo jogo da série, onde Geralt já é um temido e conhecido guerreiro na terra de Nilfgaard. Neste cenário ele é perseguido pela Wild Hunt, uma ordem de cavaleiros fantasmagóricos, que farão de tudo para abater o lendário Witcher.', 2015, 9.5, 249.9, '16'),
(17,'Dark Souls III', 'Com o fogo se apagando e o mundo caindo em ruínas, você precisa se aventurar em um universo repleto de inimigos e ambientes colossais. Jogadores entrarão em um mundo de trevas e atmosfera épica, com uma jogabilidade mais ágil e combates mais intensos.', 2016, 9.2, 99.9, '14'),
(18,'The Legend of Zelda: Ocarina of Time', 'O jogador controla o herói característico da franquia, Link, na terra de Hyrule. Link é enviado numa aventura para impedir Ganondorf, Rei da tribo dos Gerudo, de obter a Triforce, uma relíquia sagrada que garante os desejos de seu portador. ', 1998, 9.6, 199.9, 'Livre'),
(19,'Minecraft', ' Minecraft é um jogo de construção e sobrevivência em mundo aberto, na qual os jogadores interajem com vários tipos de blocos num ambiente tridimensional. Neste ambiente, jogadores constroem estruturas criativas em vários modos de jogo. ', 2009, 8.5, 89.9, 'Livre');
 
 select * from jogos;
 
 insert into generos (generos_id,nome_generos,descricao,destaques)
 value
 (1,'Ação e aventura', 'Um jogo de ação-aventura é um jogo eletrônico que combina conceitos dos gêneros de jogo de aventura e jogos de ação. Por ser um gênero misto e bem inclusivo, este talvez seja o mais amplo e diverso gênero em jogos eletrônicos. O primeiro jogo deste gênero foi Adventure (1979), lançado para Atari 2600.', 'God of War, Red Dead Redemption II, GTA V, Uncharted'),
(2,'Aventura', 'Jogos de aventura, também conhecidos como adventures, são jogos eletrônicos cuja ênfase é focada no enredo e não na parte gráfica ou na ação', 'Super Mario, Metal Gear Solid'),
(4,'Battle Royale', 'Battle royale (em tradução literal: batalha real) é um gênero de jogo eletrônico que mistura elementos de exploração, sobrevivência, e procura de equipamentos e de armas, encontrados em um jogo de sobrevivência com a jogabilidade encontrada em um jogo de último sobrevivente.', 'PUBG, Fortnite'),
(5,'Estratégia em tempo real', 'Jogo de estratégia é uma categoria de jogo (sejam de tabuleiro, de cartas, de videogames ou de computador), em que a habilidade dos jogadores em tomar decisões estratégicas supera a sorte como fator de determinação do vencedor.', 'Age of Empires II'),
(6,'Luta', 'Jogo eletrônico de luta é um gênero de videogame baseado em combate corpo a corpo entre um número limitado de personagens, em um estágio em que os limites são fixos.', 'Street Fighter 2'),
(7,'MMORPG', 'Um jogo de interpretação de personagens online e em massa para multi-jogadores (Massive Multiplayer Online Role-Playing Game - MMORPG) é um tipo de jogo on-line que suporta uma quantidade muito grande de jogadores simultâneos', 'World of Warcraft'),
(8,'MOBA', 'Arena de batalha multijogador em linha (em inglês: multiplayer online battle arena — MOBA — também conhecido como action real-time strategy) é um gênero de jogos eletrônicos derivado dos jogos de estratégia em tempo real, semelhante ao jogo Defense of the Ancients (um cenário personalizado ao jogo Warcraft III).', 'League of Legends'),
(9,'Plataforma', 'Jogo eletrônico de plataforma é um gênero de jogos eletrônicos em que o jogador corre e pula entre plataformas e obstáculos, enfrentando inimigos e coletando objetos bônus. O gênero tem seu surgimento no início dos anos 80',  'Super Mario Bros., Sonic the Hedgehog, Donkey Kong, Metal Slug, Crash Bandicoot, Prince of Persia, Castlevania, Metroid, Contra '),
(10,'RPG de ação', 'RPG eletrônico de ação (ou simplesmente RPG de ação, do inglês Action Role Playing Game - ARPG) formam um subgênero vagamente definido do RPG eletrônico (RPG de vídeo-game), que incorporam elementos de jogos de ação em tempo real ou ação-aventura ao gênero RPG, em que o jogador tem controle direto dos personagens, similar ao tipo hack and slash (corpo a corpo) e ao tiro, em vez de sistemas de combate baseados em turnos ou menus.', 'The Elder Scrolls V: Skyrim, The Witcher 3, Dark Souls III, The Legend of Zelda: Ocarina of Time'),
...
insert into desenvolvedora (desenvolvedora_id,nome_desenvolvedora,descricao,nota,mais_vendidos)
value (1,'Rockstar Games', 'Rockstar Games, Inc. é uma produtora e publicadora de jogos eletrônicos fundada em 1994. Conhecida por ter criado grandes nomes dos jogos eletrônicos, a Rockstar é criadora das famosas séries Grand Theft Auto, Red Dead, Midnight Club, Bully, Max Payne e Manhunt.', 9.3, 'Grand Theft Auto V,  Red Dead Redemption 2'),
...
(3,'Blizzard Entertainment', 'Blizzard Entertainment é uma editora e desenvolvedora de videojogos americana tendo sua sede na cidade de Irvine, California. A companhia é uma subsidiária da Activision Blizzard e foi fundada em 8 de fevereiro de 1991, sob o nome de Silicon & Synapse, por Michael Morhaime, Frank Pearce e Allen Adham.', 8.5, 'World of Warcraft, Overwatch, Diablo III, StarCraft'),
(4,'Capcom', 'Capcom Co., Ltd. é uma desenvolvedora e publicadora japonesa de jogos eletrônicos sediada em Osaka. Ela é conhecida por ter criado franquias multimilionárias, tais como Resident Evil, Street Fighter, Mega Man, Devil May Cry, Dino Crisis e Onimusha. Sua sede principal está situada em Chuo-ku, Osaka.', 8.7, 'Resident Evil 4, Ōkami, Resident Evil 2, Resident Evil Village, Street Fighter '),
(5,'CD Projekt', 'A CD Projekt S.A. é uma desenvolvedora e publicadora de jogos eletrônicos polonesa sediada em Varsóvia, Mazóvia. A companhia foi fundada em maio de 1994 por Marcin Iwiński e Michał Kiciński.', 9, 'Cyberpunk 2077, The Witcher 3: Wild Hunt, Gwent: The Witcher...'),
(6,'Ensemble Studios', 'Ensemble Studios foi uma desenvolvedora de jogos eletrônicos americana. Foi fundada por Tony Goodman em 1994 e incorporada no ano seguinte. Ela pegou emprestado o nome da Ensemble Corporation, uma empresa de consultoria fundada por Goodman em 1990.', 8, 'Halo Wars, Age of Empires, Age of Mythology'),
(7,'Epic Games', 'A Epic Games, Inc., anteriormente chamada de Potomac Computer Systems e Epic MegaGames, é uma desenvolvedora norte-americana de jogos eletrônicos e softwares sediada em Cary, Carolina do Norte. Foi fundada em 1991 por Tim Sweeney e originalmente ficava localizada na cidade de Potomac em Maryland.', 8.2, 'Fortnite, Unreal, Battle Breakers, Fall Guys'),
(8,'FromSoftware', 'FromSoftware, Inc. é uma desenvolvedora e publicadora japonesa de jogos eletrônicos sediada em Tóquio. É uma subsidiária da Kadokawa Corporation e foi fundada em novembro de 1986.', 9, 'Elden Ring, Bloodborne, Sekiro: Shadows Die Twice, Dark Souls III'),
(9,'Konami', 'Konami Holdings Corporation é uma empresa pública japonesa desenvolvedora e distribuidora de jogos eletrônicos, brinquedos, animes, cromos, tokusatsus e máquinas de caça-níqueis.', 8.9, 'Metal Gear Solid, Silent Hill, Teenage Mutant Ninja , Super Bomber'),
(10,'Krafton', 'Krafton Inc., é uma empresa sul-coreana que desenvolve e distribui videogames com sede em Bundang-gu, Seongnam. Fundada por Chang Byung-gyu em Seul em março de 2007, a empresa é conhecida por ter desenvolvido TERA, PlayerUnknown Battlegrounds e PUBG: NEW STATE, este último 2 por meio de sua subsidiária: PUBG Studios.', 8.5, 'PUBG: New State, Thunder Tier One, PUBG Mobile'),
(11,'Mojang Studios', 'Mojang Studios é uma subsidiária da Xbox Game Studios, sediada em Estocolmo, Suécia, conhecida principalmente pela criação e desenvolvimento de Minecraft. Foi fundada por Markus Persson, Jakob Porser e Carl Manneh em 2009.', 7.5, 'Minecraft'),
(12,'Naughty Dog', 'A Naughty Dog, LLC é uma desenvolvedora norte-americana de jogos eletrônicos sediada em Santa Mônica, Califórnia. Foi fundada em setembro de 1984 pelos então estudantes colegiais Andy Gavin e Jason Rubin como JAM Software, sendo renomeada para seu nome atual alguns anos depois em 1989.', 9.2, 'The Last of Us, The Last of Us Part II, Uncharted 4, Uncharted 2'),
(13,'Riot Games', 'A Riot Games, Inc. é uma desenvolvedora, editora e organizadora de torneios de esportes eletrônicos americana com sede em West Los Angeles, Califórnia.', 8.2, 'League of Legends, Valorant, Legends of Runeterra'),
(14,'Santa Monica Studio', 'Santa Monica Studio é uma desenvolvedora norte-americana de jogos eletrônicos sediada em Los Angeles, Califórnia. O estúdio foi fundado em 1999 por Allan Becker e estava originalmente localizado em Santa Mônica, Califórnia, até se mudar para Playa Vista em 2014', 9.2, 'Saga God of War'),
(15,'Nitendo', 'A Nintendo Co., Ltd. é uma desenvolvedora e publicadora japonesa de jogos eletrônicos e consoles sediada em Quioto. Foi fundada em setembro de 1889 pelo artesão Fusajiro Yamauchi e originalmente era uma fabricante de cartas de baralho tradicionais japonesas. ', 9.4, 'The Super Mario Bros, Pokémon, The Legend of Zelda');
...
update jogos
set nome_jogos = 'Forza Horizon'
where nome_jogos = 'Minecraft';

select nome_jogos from jogos;

delete from generos
where nome_generos = 'MOBA';

select * from generos;

select c.generos_id, g.nome_generos, g.destaques
from catalogo_de_jogos c
inner join generos g
on c.generos_id = g.generos_id
group by g.generos_id;

select c.catalogo_id, g.generos_id, g.nome_generos as Generos, g.destaques as JogosEmDestaque
from catalogo_de_jogos c
inner join generos g
on c.catalogo_id = g.generos_id
group by g.nome_generos;
