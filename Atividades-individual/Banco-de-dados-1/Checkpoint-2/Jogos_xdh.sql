...
insert into desenvolvedora (desenvolvedora_id,nome,descricao,nota,mais_vendidos)
value (98, 'Rockstar Games', 'Rockstar Games, Inc. é uma produtora e publicadora de jogos eletrônicos fundada em 1994. Conhecida por ter criado grandes nomes dos jogos eletrônicos, a Rockstar é criadora das famosas séries Grand Theft Auto, Red Dead, Midnight Club, Bully, Max Payne e Manhunt.', 9.3, 'Grand Theft Auto V,  Red Dead Redemption 2'),
(69, 'Bethesda Game Studios', 'A Bethesda Softworks LLC é um braço de publicação norte-americano de jogos eletrônicos sediada em Rockville, Maryland, como subsidiária do Xbox Game Studios desde 2020. Foi fundada em junho de 1986 por Christopher Weaver como uma divisão da Media Technology e em 1999 tornou-se uma subsidiária da ZeniMax Media.', 8, 'Fallout 4, Fallout 76, The Elder Scrolls V'),
(75, 'Blizzard Entertainment', 'Blizzard Entertainment é uma editora e desenvolvedora de videojogos americana tendo sua sede na cidade de Irvine, California. A companhia é uma subsidiária da Activision Blizzard e foi fundada em 8 de fevereiro de 1991, sob o nome de Silicon & Synapse, por Michael Morhaime, Frank Pearce e Allen Adham.', 8.5, 'World of Warcraft, Overwatch, Diablo III, StarCraft'),
(31, 'Capcom', 'Capcom Co., Ltd. é uma desenvolvedora e publicadora japonesa de jogos eletrônicos sediada em Osaka. Ela é conhecida por ter criado franquias multimilionárias, tais como Resident Evil, Street Fighter, Mega Man, Devil May Cry, Dino Crisis e Onimusha. Sua sede principal está situada em Chuo-ku, Osaka.', 8.7, 'Resident Evil 4, Ōkami, Resident Evil 2, Resident Evil Village, Street Fighter '),
(100, 'CD Projekt', 'A CD Projekt S.A. é uma desenvolvedora e publicadora de jogos eletrônicos polonesa sediada em Varsóvia, Mazóvia. A companhia foi fundada em maio de 1994 por Marcin Iwiński e Michał Kiciński.', 9, 'Cyberpunk 2077, The Witcher 3: Wild Hunt, Gwent: The Witcher...'),
(111, 'Ensemble Studios', 'Ensemble Studios foi uma desenvolvedora de jogos eletrônicos americana. Foi fundada por Tony Goodman em 1994 e incorporada no ano seguinte. Ela pegou emprestado o nome da Ensemble Corporation, uma empresa de consultoria fundada por Goodman em 1990.', 8, 'Halo Wars, Age of Empires, Age of Mythology'),
(89, 'Epic Games', 'A Epic Games, Inc., anteriormente chamada de Potomac Computer Systems e Epic MegaGames, é uma desenvolvedora norte-americana de jogos eletrônicos e softwares sediada em Cary, Carolina do Norte. Foi fundada em 1991 por Tim Sweeney e originalmente ficava localizada na cidade de Potomac em Maryland.', 8.2, 'Fortnite, Unreal, Battle Breakers, Fall Guys'),
(201, 'FromSoftware', 'FromSoftware, Inc. é uma desenvolvedora e publicadora japonesa de jogos eletrônicos sediada em Tóquio. É uma subsidiária da Kadokawa Corporation e foi fundada em novembro de 1986.', 9, 'Elden Ring, Bloodborne, Sekiro: Shadows Die Twice, Dark Souls III'),
(45, 'Konami', 'Konami Holdings Corporation é uma empresa pública japonesa desenvolvedora e distribuidora de jogos eletrônicos, brinquedos, animes, cromos, tokusatsus e máquinas de caça-níqueis.', 8.9, 'Metal Gear Solid, Silent Hill, Teenage Mutant Ninja , Super Bomber'),
(110, 'Krafton', 'Krafton Inc., é uma empresa sul-coreana que desenvolve e distribui videogames com sede em Bundang-gu, Seongnam. Fundada por Chang Byung-gyu em Seul em março de 2007, a empresa é conhecida por ter desenvolvido TERA, PlayerUnknown Battlegrounds e PUBG: NEW STATE, este último 2 por meio de sua subsidiária: PUBG Studios.', 8.5, 'PUBG: New State, Thunder Tier One, PUBG Mobile'),
(199, 'Mojang Studios', 'Mojang Studios é uma subsidiária da Xbox Game Studios, sediada em Estocolmo, Suécia, conhecida principalmente pela criação e desenvolvimento de Minecraft. Foi fundada por Markus Persson, Jakob Porser e Carl Manneh em 2009.', 7.5, 'Minecraft'),
(125, 'Naughty Dog', 'A Naughty Dog, LLC é uma desenvolvedora norte-americana de jogos eletrônicos sediada em Santa Mônica, Califórnia. Foi fundada em setembro de 1984 pelos então estudantes colegiais Andy Gavin e Jason Rubin como JAM Software, sendo renomeada para seu nome atual alguns anos depois em 1989.', 9.2, 'The Last of Us, The Last of Us Part II, Uncharted 4, Uncharted 2'),
(121, 'Riot Games', 'A Riot Games, Inc. é uma desenvolvedora, editora e organizadora de torneios de esportes eletrônicos americana com sede em West Los Angeles, Califórnia.', 8.2, 'League of Legends, Valorant, Legends of Runeterra'),
(87, 'Santa Monica Studio', 'Santa Monica Studio é uma desenvolvedora norte-americana de jogos eletrônicos sediada em Los Angeles, Califórnia. O estúdio foi fundado em 1999 por Allan Becker e estava originalmente localizado em Santa Mônica, Califórnia, até se mudar para Playa Vista em 2014', 9.2, 'Saga God of War');

insert into catalogo_de_jogos (catalogo_id,generos_id,id_jogos,id_desenvolvedora)
value 
(2, 95, 103590, 69),
(4, 185, 104050, 75),
(5, 89, 124300, 31),
...
select jogos_id, nome_jogos, nota
from catalogo_de_jogos
inner join jogos;
