...
('Ração Premier - 12kg', 234.90, 'Cachorros'),
('Ração Royal Canin Max - 15kg', 391.59, 'Cachorros'),
('Ração Royal Canin Premium - 1kg', 68.19, 'Gatos'),
('Ração Nutribetta - 12g', 10.55, 'Peixe'),
('Petisco Pedigree Dentastix', 23.39, 'Cachorros'),
('Areia para gatos - 12kg', 37.99, 'Gatos'),
('Antipulgas Simparic 20 mg - cães 5,1 a 10 kg', 95.50, 'Cachorros'),
('Arranhador Cansei de Ser Gato', 279.99, 'Gatos'),
('Gaiola Bragança Criadeira', 473.32, 'Passaros'),
('Banho e tosa', 60.90, 'Serviços'),
('Veterinária', 120.00, 'Serviços'),
('Ração Origens Premium - 1kg', 52.90, 'Cachorros');
...
select e.estoque_id, p.nome as 'Nome do Produto', p.descricao_produto as 'Descrição do Produto', p.preco as "Preço Unitário", e.quantidade as 'Quantidade', quantidade*preco as 'Valor em estoque'
from estoque e
...
begin
select c.nome as 'Nome_Cliente', CONCAT(e.logradouro,', ',e.numero) as 'Endereço_Cliente'
from clientes c
